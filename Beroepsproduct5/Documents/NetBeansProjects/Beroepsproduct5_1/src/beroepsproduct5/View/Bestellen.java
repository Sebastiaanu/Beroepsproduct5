...
//                        
            DbConnector db = new DbConnector();
            String strSQL = "insert into prodinbestel (bestellingen_bestelNr, producten_productId, plek, tijdPlaatsing) VALUES('" + nieuwProductInBestel.getBestelId() + "','"
                    + nieuwProductInBestel.getProductId() + "','" + nieuwProductInBestel.getPlek() + "', now())";
            int result = db.executeDML(strSQL);
